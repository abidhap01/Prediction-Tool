 ...
 */
public class IntermediateVisuaForm extends javax.swing.JFrame {

    /**
     * Creates new form IntermediateVisuaForm
     */
    public IntermediateVisuaForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sample Attribute and Range Visualization for PM 2.5 data");
        jLabel2.setToolTipText("");

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/myprediction/intermediate.jpeg"))); // NOI18N
    ...
    private void moreInfoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_moreInfoButtonActionPerformed
       setVisible(false);
       IntermediateVisForm quFrame=new IntermediateVisForm();
        quFrame.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntermediateVisuaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntermediateVisuaForm().setVisible(true);
            }
        });
    }
